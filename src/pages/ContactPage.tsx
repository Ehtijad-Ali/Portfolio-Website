...
const MailIcon = ({ size = 20, color = 'currentColor' }: { size?: number; color?: string }) => (
...
const MessageIcon = ({ size = 20, color = 'currentColor' }: { size?: number; color?: string }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--color-bg)', fontFamily: 'var(--font-sans)', color: 'var(--color-text-primary)' }}>
      ...
      >
        <div className="section-container">
          <div className="max-w-4xl text-left">
            ...
            >
              Have a project in mind, a question, or just want to say hi? I'm available Mon–Sat and respond within 24 hours.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="section-container">
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            >
              ...
              >
                Have a project in mind, want to collaborate, or just want to say hello? I'd love to hear from you. Fill out the form or reach out directly using the info below.
              </p>
                  ...
                  <li key={item.label}>
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        ...
                        <span
                          className="font-medium group-hover:text-[var(--color-accent)] transition-colors"
            ...
            >
              {submitted ? (
                <div
                  className="p-8 md:p-10 rounded-xl flex flex-col items-center justify-center text-center gap-4 min-h-[400px]"
                  style={{
                    background: 'var(--color-surface)',
                    border: '1px solid var(--color-border)',
                  }}
      ...
      <section className="section" style={{ background: 'var(--color-surface)', ...fade(0.35) }}>
        <div className="section-container">
          ...
          <div className="mx-auto flex max-w-3xl flex-col gap-3">
            {faqs.map((faq, index) => {
              const isOpen = false; // Simplified for this implementation
      ...
      <section className="section" style={fade(0.4)}>
        <div className="section-container">
          <motion.div
            className="max-w-4xl mx-auto p-8 md:p-10 rounded-xl"
            style={{
              background: 'var(--color-surface)',
              border: '1px solid var(--color-border)',
            }}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p 
                        style={{ fontSize: 14, color: 'var(--color-text-primary)', fontWeight: 500 }}
                      >
                        Mon – Sat, 9 AM – 6 PM
                      </p>
                    </div>
